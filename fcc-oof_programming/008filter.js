...
* (we've called that val) as an argument.
*
* Any array element for which the callback returns true will be kept and 
* elements that return false will be filtered out.
*
* The following code is an example of using filter to remove array elements 
